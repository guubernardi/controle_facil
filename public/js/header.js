    ...
    <div class="container nav-inner">
      ...
      <button class="nav-toggle" aria-label="Abrir menu" aria-expanded="false">
        <svg width="24" height="24" viewBox="0 0 24 24" aria-hidden="true">
          <path class="bar bar1" d="M4 7h16" stroke="currentColor" stroke-width="2" stroke-linecap="round"></path>
          <path class="bar bar2" d="M4 12h16" stroke="currentColor" stroke-width="2" stroke-linecap="round"></path>
          <path class="bar bar3" d="M4 17h16" stroke="currentColor" stroke-width="2" stroke-linecap="round"></path>
        </svg>
      </button>

      <nav class="nav-links" role="navigation" aria-label="Menu principal">
        <a data-active="index" href="/index.html">
          <svg class="nav-ico" viewBox="0 0 16 16"><path d="M8 1L3 5v7h10V5L8 1z" fill="currentColor"></path></svg>
          <span>Devoluções</span>
        </a>
        <a data-active="dashboard" href="/dashboard.html">
          <svg class="nav-ico" viewBox="0 0 16 16"><path d="M2 2h5v5H2V2zm7 0h5v9h-5V2zM2 9h5v5H2V9z" fill="currentColor"></path></svg>
          <span>Dashboard</span>
        </a>
        <a data-active="logs" href="/logs.html">
          <svg class="nav-ico" viewBox="0 0 16 16"><path d="M2 3h12v2H2zM2 7h12v2H2zM2 11h12v2H2z" fill="currentColor"></path></svg>
