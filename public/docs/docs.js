    ...
    sections: [
      {
        id: "visao",
        h: "Visão geral",
        html: "<p>Conexão via OAuth do Bling para sincronizar dados (pedidos, clientes e NF) – quando habilitado.</p>",
      },
      {
        id: "env",
        h: "Variáveis",
  ...
  api: {
    ...
    sections: [
      ...
      },
      {
        id: "errors",
        h: "Modelo de erros",
        html: '<pre>{ "ok": false, "error": "invalid_json" }\n\n{ "error": "Falha ao listar eventos" }</pre>',
      },
    ],
  },
